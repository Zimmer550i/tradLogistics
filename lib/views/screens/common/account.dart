...
class _AccountState extends State<Account> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: HomeBar(),
      body: Obx(()=> _controller.isLoading.value ? LoadingWidget():
      _controller.hasError.value? AppErrorWidget(
                ...
                children: [
                  ProfilePicture(
                    image: profile?.profileImage != null
                        ? EnvironmentConfig.imageUrl + profile!.profileImage!
                        : null,
                    size: 120,
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(name.isNotEmpty ? name : '—', style: AppTexts.dsmm),
                    ],
                  ),
